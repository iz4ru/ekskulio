...
@section('title', 'Ekskulio | Impor Kategori Ekstrakurikuler')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-md w-full mt-14">
        ...
        <div class="flex gap-4 my-4 justify-between">
            <div>
                <h1 class="text-xl lg:text-2xl font-semibold text-gray-600">Impor Kategori Ekstrakurikuler</h1>
                <p class="text-sm lg:text-base text-gray-400">Impor kategori ekstrakurikuler dari file.</p>
            </div>
        </div>
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900">Impor Kategori Ekstrakurikuler</h2>

                <form action="{{ route('extracurricular-category.import.store') }}" method="POST"
                    enctype="multipart/form-data" id="academic-year-form">
                    @csrf
