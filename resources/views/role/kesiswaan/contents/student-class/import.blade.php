...
@section('title', 'Ekskulio | Impor Kelas')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-md w-full mt-14">
        ...
        <div class="flex gap-4 my-4 justify-between">
            <div>
                <h1 class="text-xl lg:text-2xl font-semibold text-gray-600">Impor Kelas</h1>
                <p class="text-sm lg:text-base text-gray-400">Impor kelas dari file.</p>
            </div>
        </div>
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <form action="{{ route('student-class.import.store') }}" method="POST"
                        ...
                        <div class="sm:col-span-2 border-2 p-4 border-gray-200 border-dashed rounded-md w-full">
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center bg-gray-50 border border-gray-300 rounded-md p-2.5">
                                    <a href="{{ asset('templates/import-kelas.xlsx') }}" download
