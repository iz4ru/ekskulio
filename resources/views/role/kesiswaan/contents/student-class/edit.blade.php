...
@section('title', 'Ekskulio | Edit Kelas')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-md w-full mt-14">
        ...
        <div class="flex gap-4 my-4 justify-between">
            <div>
                <h1 class="text-xl lg:text-2xl font-semibold text-gray-600">Edit Kelas</h1>
                <p class="text-sm lg:text-base text-gray-400">Ubah data kelas yang sudah ada.</p>
            </div>
        </div>
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900">Edit Data Kelas</h2>

                <form action="{{ route('student-class.update', $studentClass->id) }}" method="POST" id="class-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="class_name" id="class_name" placeholder="Masukkan nama kelas"
                                ...
                                value="{{ old('class_name', $studentClass->name) }}" required autofocus>
