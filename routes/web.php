...
use App\Http\Controllers\UnauthorizedUserController;
...
Route::get('unauthorized/no-extracurricular', [UnauthorizedUserController::class, 'noExtracurricular'])->name('unauthorized.no-extracurricular');

Route::middleware('auth')->group(function () {
    Route::middleware('check.role:kesiswaan')->group(function () {
        ...
        Route::prefix('academic-years')
            ...
            ->group(function () {
                ...
                Route::get('/export-template', [AcademicYearController::class, 'export'])->name('export');
            });
    ...
    Route::middleware(['check.role:pembina', 'advisor.has.extracurricular'])->group(function () {
    ...
    Route::middleware(['check.role:pembina,kesiswaan', 'advisor.has.extracurricular'])->group(function () {
        Route::prefix('scores')
            ->name('scores.')
            ->group(function () {
    ...
    Route::middleware(['check.role:pembina,kesiswaan,admin', 'advisor.has.extracurricular'])->group(function () {
